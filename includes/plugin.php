...
final class Plugin {
	...
	public function my_plugin_frontend_stylesheets() {
		...
		wp_register_style( 'blog-carousel-css', plugins_url( '/assets/css/blog-carousel.css', __FILE__ ) );
		wp_register_style( 'news-media', plugins_url( '/assets/css/news-media.css', __FILE__ ) );

		wp_enqueue_style( 'swiper-bundle' );
		wp_enqueue_style( 'blog-carousel-css' );
		wp_enqueue_style( 'news-media' );
	...
	public function my_plugin_frontend_scripts() {
		...
		wp_register_script( 'swiper-bundle-js', plugins_url( '/assets/js/swiper-bundle.min.js', __FILE__ ), [ 'jquery' ], '', true );
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/news-media.php' );

		$widgets_manager->register( new \Admission_Sight_Addon\Admission_Blog_Carousel() );
		$widgets_manager->register( new \Admission_Sight_Addon\Admission_Sight_News_Media() );
